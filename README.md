...
- [fogofwar](https://github.com/MassBattle/FogOfWar): fog of war; includes the minimap plugin.
- landmark: landmark system, also usable as an editor tool.
- openrtscamera: open-source RTS camera and RTS command panel.
